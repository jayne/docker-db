...
#               mysqld --user=mysql --datadir="$DATADIR" --basedir=/usr/local/mysql --pid-file="$PIDFILE" &
    ...
    echo 'Unsupported command. Make sure to include CMD to invoke as argument 1.'
    echo 'This is usually passed as the "CMD" from your Dockerfile'
    echo 'Example:   CMD ["mysqld"]'
fi
